...
Il firmware di sistema del server Lenovo SR665 V3 contiene numerosi parametri di ottimizzazione che possono essere impostati tramite l'interfaccia UEFI. Questi parametri di tuning possono influire su tutti gli aspetti del funzionamento del server e sulle prestazioni del server.
