...
NOTE: Per la dimensione corretta da utilizzare, vedere link:beegfs-deploy-recommended-volume-percentages.html["Percentuali consigliate di overprovisioning del pool di storage"] ..
