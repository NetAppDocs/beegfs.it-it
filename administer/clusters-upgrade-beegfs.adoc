...
NOTE: Se stai eseguendo l'aggiornamento a BeeGFS 8, consulta la link:clusters-upgrade-beegfs-v8.html["Esegui l'aggiornamento a BeeGFS 8"] procedura invece.
...
| 7.4.6 | 8,0 | Sì | Eseguire l'aggiornamento utilizzando le istruzioni nella link:clusters-upgrade-beegfs-v8.html["Esegui l'aggiornamento a BeeGFS 8"] procedura. 


| 7.4.6 | 8,1 | Sì | Eseguire l'aggiornamento utilizzando le istruzioni nella link:clusters-upgrade-beegfs-v8.html["Esegui l'aggiornamento a BeeGFS 8"] procedura. 


| 7.4.6 | 8,2 | Sì | Eseguire l'aggiornamento utilizzando le istruzioni nella link:clusters-upgrade-beegfs-v8.html["Esegui l'aggiornamento a BeeGFS 8"] procedura. 
|===
