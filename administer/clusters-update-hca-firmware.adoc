...
TIP: Per gli adattatori Lenovo ConnectX-7, utilizzare `mlxfwmanager_LES` lo strumento, disponibile alla pagina di NVIDIAlink:https://network.nvidia.com/support/firmware/lenovo-intelligent-cluster/["Firmware OEM"^].
...
----
.. Riavviare il  `eseries_nvme_ib.service` .
+
[source, console]
----
systemctl restart eseries_nvme_ib.service
----
.. Verificare che i volumi dell'array di archiviazione E-Series siano presenti.
