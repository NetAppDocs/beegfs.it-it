...
TIP: Per ulteriori informazioni sulle versioni di BeeGFS, vedere link:https://doc.beegfs.io/latest/advanced_topics/upgrade.html["Documentazione sull'aggiornamento di BeeGFS"^].
